...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Add Leave Form",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/addLeave.jsp",
		"javax.portlet.name=AddLeavePortlet",
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class AddLeavePortlet extends MVCPortlet {

	private static Log log = LogFactoryUtil.getLog(AddLeavePortlet.class);
	...
	public void addLeave(ActionRequest request, ActionResponse response) {
		...
		long leaveId = counterLocalService.increment(AddLeavePortlet.class.getName());
		...
		System.out.println("<a href= 'http://localhost:8080/group/employee/leave-tracker'></a>");
	}
