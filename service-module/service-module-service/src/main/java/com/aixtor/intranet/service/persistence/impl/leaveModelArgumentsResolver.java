...
/**
 * The arguments resolver class for retrieving value from leave.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@Component(service = ArgumentsResolver.class)
public class leaveModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return leaveImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return leaveTable.INSTANCE.getTableName();
	}

	private static Object[] _getValue(
		leaveModelImpl leaveModelImpl, String[] columnNames, boolean original) {
